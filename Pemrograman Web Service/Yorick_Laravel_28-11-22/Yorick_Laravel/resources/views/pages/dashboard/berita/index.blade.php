...
<div class="content-header">
    ...
    <div class="card-body">
        ...
        @endif
        <a href="{{ route('dashboardBeritaCreate') }}" class="btn btn-primary mb-3">Tambah Berita</a>
            ...
            <tbody>
                @foreach ($beritas as $berita)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('dashboardBeritaShow', $berita->slug) }}" class="btn btn-outline-info"><i class="far fa-eye nav-icon"></i></a>
